/*
 * Created by Nguyen Kim Khanh on 4/21/22, 7:26 AM
 *     goodhere.cpm@gmail.com
 *     Last modified 4/21/22, 7:26 AM
 *     Copyright (c) 2022.
 *     All rights reserved.
 */
...
Future<String> getAddress(double lat, double log) async {
  ...
  return address.streetNumber.toString() +
      " " +
...
Future<Coordinates?> findAddress(String address) async {
  GeoCode geo = GeoCode();
  try {
    Coordinates coordinates = await geo.forwardGeocoding(address: address);
    return coordinates;
  } catch (e) {
    return null;
  }
